...
class ExchGwHuobiRestfulApi(RESTfulApiSocket):
    """
    Exchange gateway Huobi RESTfulApi
    """
    def __init__(self):
    ...
    def get_order_book_link(cls, instmt):
        return "http://api.huobi.pro/market/depth?symbol=%s&type=step0" % instmt.get_instmt_code()

    @classmethod
    def get_trades_link(cls, instmt):
        return "http://api.huobi.pro/market/trade?symbol=%s" % instmt.get_instmt_code()
...
class ExchGwHuobi(ExchangeGateway):
    ...
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwHuobiRestfulApi(), db_clients)

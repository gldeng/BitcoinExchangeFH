...
class ExchGwGeminiRestfulApi(RESTfulApiSocket):
    """
    Exchange gateway Gemini RESTfulApi
    """
    def __init__(self):
    ...
    def get_order_book_link(cls, instmt):
        return "https://api.gemini.com/v1/book/%s" % instmt.get_instmt_code()

    @classmethod
    def get_trades_link(cls, instmt):
        return "https://api.gemini.com/v1/trades/%s" % instmt.get_instmt_code()
    ...
    def parse_l2_depth(cls, instmt, raw):
        ...
        if cls.get_bids_field_name() in keys and \
           cls.get_asks_field_name() in keys:
            ...
            # Date time
            date_time = float(raw[cls.get_bids_field_name()][0][cls.get_order_book_timestamp_field_name()])
...
class ExchGwGemini(ExchangeGateway):
    """
    Exchange gateway Gemini
    """
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwGeminiRestfulApi(), db_clients)
